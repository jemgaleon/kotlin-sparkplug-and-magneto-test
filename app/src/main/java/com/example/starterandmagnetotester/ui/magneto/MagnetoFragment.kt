...
class MagnetoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val magnetoViewModel = ViewModelProvider(this).get(MagnetoViewModel::class.java)

        _binding = FragmentMagnetoBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textMagneto

        magnetoViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
